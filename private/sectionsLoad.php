...
// -------
//
function qruqsp_fielddaylog_sectionsLoad($ciniki) {
    ...
    $areas = array(
        ...
        'CANADA' => array(
            ...
            'sections' => array(
                ...
                array('label' => 'NB', 'name' => 'New Brunswick', 'bit' => 75),
                array('label' => 'NL', 'name' => 'Newfoundland/Labrador', 'bit' => 77),
                array('label' => 'NS', 'name' => 'Nova Scota', 'bit' => 85),
                ...
                array('label' => 'TER', 'name' => 'Northern Territories', 'bit' => 78),
            ),
        ),
    );
